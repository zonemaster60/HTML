...
REM run_software_license_manager.bat 1  -> start server + open browser
REM run_software_license_manager.bat 0  -> stop server

set "PORT=8000"
set "URL=http://localhost:%PORT%/software_license_manager/software-license-manager.html"
set "PIDFILE=%~dp0software_license_manager.pid"
set "error=0"
...
cls
ECHO ---------------------------------
ECHO 1. Start Software License Manager

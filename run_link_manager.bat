...
REM run_link_manager.bat 1  -> start server + open browser
REM run_link_manager.bat 0  -> stop server

set "PORT=8000"
set "URL=http://localhost:%PORT%/link_manager/link-manager.html"
set "PIDFILE=%~dp0link_manager.pid"
set "error=0"
